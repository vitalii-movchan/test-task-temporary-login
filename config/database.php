    ...
    */
    ...
    'connections' => [
        ...
        'vertica' => [
            'driver' => 'odbc',
            'dsn' => 'VerticaDev',
            'host' => env('DB_HOST_VERTICA', 'nux-game-vertica'),
            'port' => env('DB_PORT_VERTICA', 5433), //EXACTLY DIGITS, NOT STRING
            'database' => env('DB_DATABASE_VERTICA', 'VMart'),
            'username' => env('DB_USERNAME_VERTICA', 'dbadmin'),
            'password' => env('DB_PASSWORD_VERTICA', 'vertica'),
           // 'schema' => 'public',
            //'sslmode' => 'allow',
           /* 'options' => [
